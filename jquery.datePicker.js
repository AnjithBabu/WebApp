			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a href="#" class="dp-choose-date" title="' + $.dpText.TEXT_CHOOSE_DATE + '"><img src="images/Calendar.png" border="0" style="margin-top:-9px;margin-left:-4px;"  ></a>')
								.bind(
									'click',
									function()
									{
